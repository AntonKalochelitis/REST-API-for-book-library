...
class Author
{
    ...
    #[Validator\Constraints\Length(min: 2, minMessage: "Last name must be at least 2 characters long")]
    private ?string $lastName = null;

    #[ORM\Column(length: 255, nullable: false)]
    #[Validator\Constraints\NotBlank(message: "First name is required")]
    #[Validator\Constraints\Length(min: 2, minMessage: "First name must be at least 2 characters long")]
